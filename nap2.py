...
# TODO RENDER TWICE THE GIVEN SVG FILE TO OMMIT TRAFFIC SIZE
##########################################################################################
...
class NapMainWindow(QWidget):
	def __init__(self):		# constructor
		...
		self.showTrafficSize = QCheckBox()
		self.showTrafficSize.setText("Show Traffic Size in Bytes")
		# self.showTrafficSize.setTristate(False)
		self.showTrafficSize.setChecked(True)
		graphicsLayout.addWidget(self.showTrafficSize)
